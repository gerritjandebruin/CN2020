...
Parallel(n_jobs=30)(delayed(feature_construction)(path=f'exp4/{i}/{do}/', position=pos, only_singlecore=True) for pos, (i, do) in enumerate(product(range(1, 11), ['random', 'train', 'test'])))
