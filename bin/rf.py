...
default_param_grid = {
  ...
  'classifier': [RandomForestClassifier(oob_score=True, n_jobs=10, random_state=random_state)],
  'classifier__n_estimators': [5, 10, 50, 100],
  'classifier__criterion': ['gini', 'entropy'],
  'classifier__max_depth': [1, 2, 4, 8, 16, 32, None],
  'classifier__class_weight': ['balanced', None],
  'classifier__max__features': ['auto', None]
}
param_grid = [
